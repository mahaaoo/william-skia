...
const TabOneScreen: React.FC<{}> = (props: any) => {
  return (
    <ScrollView style={styles.container}>
      ...
      <ListRow title={"Color"} onPress={() => {
        props.navigation.navigate('Color');
      }} />
      <ListRow title={"Shape"} onPress={() => {
        props.navigation.navigate('Shape');
      }} />
      <ListRow title={"Transitions"} onPress={() => {
        props.navigation.navigate('Transitions');
      }} />
      <ListRow title={"DarkMode"} onPress={() => {
        props.navigation.navigate('DarkMode');
      }} />
      <ListRow title={"Rings"} onPress={() => {
        props.navigation.navigate('Rings');
      }} />
    </ScrollView>
  );
}
